...
const COURSES = [
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=R6vO5haH7pM',
    whatYoullLearn: ['Master React 19 and Next.js 15 from scratch','Build full-stack apps with Server Components','Manage complex state with Redux and Context API','Implement authentication and database integration'] 
  },
  { 
    ...
    whatYoullLearn: ['Analyze complex datasets using Python and Pandas','Build and deploy Machine Learning models','Visualize data with Matplotlib and Seaborn','Implement deep learning with Neural Networks'] 
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=JW7fG86P_04',
    whatYoullLearn: ['Design professional UI for mobile and web','Create interactive prototypes in Figma','Master design systems and typography','Conduct user research and usability testing'] 
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=mE7IDf2SmJg',
    whatYoullLearn: ['Understand the architecture of Large Language Models','Build context-aware apps with LangChain','Implement Retrieval Augmented Generation (RAG)','Master advanced prompt engineering techniques']
  },
  { 
    ...
    whatYoullLearn: ['Containerize applications with Docker','Orchestrate clusters using Kubernetes','Deploy scalable apps on AWS (EKS)','Set up robust CI/CD pipelines']
  },
  { 
    ...
    whatYoullLearn: ['Build beautiful native apps for iOS and Android','Master the Dart programming language','Integrate Firebase for real-time data','Implement complex state management']
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=m8I7eGZzFb0',
    whatYoullLearn: ['Design large-scale distributed systems','Master load balancing and caching strategies','Understand database sharding and replication','Prepare for top-tier tech system design interviews']
  },
  { 
    ...
    whatYoullLearn: ['Master SQL queries and database design','Work with NoSQL databases like MongoDB','Understand indexing and performance tuning','Connect databases to your applications']
  },
  { 
    ...
    whatYoullLearn: ['Perform professional penetration testing','Master tools like Kali Linux and Metasploit','Secure web applications against OWASP Top 10','Understand the legalities of ethical hacking']
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=Z6z_VByzCsc',
    whatYoullLearn: ['Define product-market fit and user personas','Master Agile and Scrum methodologies','Create data-driven product roadmaps','Coordinate effectively between tech and business teams']
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=VguJDPL1Yt0',
    whatYoullLearn: ['Master advanced TypeScript types and generics','Apply design patterns to TypeScript apps','Architect maintainable large-scale applications','Deep dive into the TypeScript compiler']
  },
  { 
    ...
    videoUrl: 'https://www.youtube.com/watch?v=iqQgED9rbV4',
    whatYoullLearn: ['Build neural networks with PyTorch and TensorFlow','Master Convolutional Neural Networks (CNNs)','Understand and implement Transformers','Deploy deep learning models at scale']
  },
];
