              ...
              >
                <div className="avatar-ring">
                  ...
                  <div className="avatar-fallback">
                    {user ? user.name.split(' ').map(n=>n[0]).join('').slice(0,2) : 'HR'}
                  </div>
                </div>
                <div className="profile-info">
                  <span className="profile-name">{user ? user.name.split(' ')[0]+' '+user.name.split(' ')[1]?.[0]+'.' : 'Hari R.'}</span>
                  <span className="profile-role">{user?.plan === 'pro' ? 'Pro Learner' : 'Learner'}</span>
                </div>
