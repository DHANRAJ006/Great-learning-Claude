...
export const STATIC_COURSES = [
  {
    ...
    whatYoullLearn: [
      'Master React 19 and Next.js 15 from scratch',
      'Build full-stack apps with Server Components',
      'Manage complex state with Redux and Context API',
  ...
  },
  {
    ...
    whatYoullLearn: [
      'Design professional UI for mobile and web',
      'Create interactive prototypes in Figma',
      'Master design systems and typography',
  ...
  },
  {
    ...
    whatYoullLearn: [
      'Build AI apps using LangChain and GPT-4',
      'Implement RAG (Retrieval Augmented Generation)',
      'Master prompt engineering techniques',
      'Deploy AI agents and vector databases'
    ],
  },
  {
    _id: 'c5',
    ...
    whatYoullLearn: [
      'Master Kubernetes orchestration and Docker containers',
  ...
  },
  {
    ...
    whatYoullLearn: [
      'Build native apps for iOS and Android with Flutter',
  ...
  },
  {
    ...
    whatYoullLearn: [
      ...
      'Implement database sharding and caching',
      'Prepare for top-tier tech system design interviews'
    ],
  },
  {
    _id: 'c8',
